...

{
  ...
  puStack_c = &DAT_00403208;
  puStack_10 = &DAT_004021a2;
  *unaff_FS_OFFSET = &local_14;
  local_1c = &stack0xffffff68;
  local_8 = 0;
  __set_app_type(2);
  DAT_0040492c = 0xffffffff;
  DAT_00404930 = 0xffffffff;
  puVar2 = (undefined4 *)__p__fmode();
  *puVar2 = DAT_00404850;
  puVar2 = (undefined4 *)__p__commode();
  *puVar2 = DAT_0040484c;
  _DAT_00404928 = *(undefined4 *)_adjust_fdiv_exref;
  FUN_004021a0();
  if (DAT_00404848 == 0) {
    __setusermatherr(&LAB_00402190);
  }
  __setdefaultprecision();
  initterm(&DAT_00404010,&DAT_00404014);
  local_2c[0].newmode = DAT_00404844;
  __getmainargs(&local_40,&local_3c,local_38,DAT_00404840,local_2c);
  initterm(&DAT_00404000,&DAT_0040400c);
