 ...
 * Function: FUN_00404bd0
 * Entry: 00404bd0
 * Namespace: Global
 * Prototype: undefined4 FUN_00404bd0(void * this, char * param_1, char * param_2, char * param_3)
 */


undefined4 __thiscall FUN_00404bd0(void *this,char *param_1,char *param_2,char *param_3)

{
  ...
  *(char **)((int)this + 0x10) = pcVar2;
  ...
  if (((*(int *)((int)this + 8) != 0) && (*(int *)((int)this + 0xc) != 0)) &&
    ...
    LVar3 = RegCreateKeyExA((HKEY)0x80000001,local_80,0,&DAT_00411318,0,0xf003f,
                            (LPSECURITY_ATTRIBUTES)0x0,(PHKEY)((int)this + 0x18),&local_84);
    if ((LVar3 == 0) &&
       (LVar3 = RegCreateKeyExA((HKEY)0x80000002,local_80,0,&DAT_00411318,0,0xf003f,
