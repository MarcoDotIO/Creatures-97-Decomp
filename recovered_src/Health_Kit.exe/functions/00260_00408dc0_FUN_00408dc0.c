 ...
 * Entry: 00408dc0
 * Namespace: Global
 * Prototype: undefined FUN_00408dc0(void * this, RECT * param_1, int param_2, int param_3)
 */


void __thiscall FUN_00408dc0(void *this,RECT *param_1,int param_2,int param_3)

{
  ...
  *unaff_FS_OFFSET = &local_10;
  if (*(int *)((int)this + 0x48) != 0) {
    ...
    FUN_00402660(*(void **)((int)this + 0x48),&local_68.left);
