 ...
 * Entry: 004064e0
 * Namespace: Global
 * Prototype: undefined4 FUN_004064e0(void * param_1)
 */


undefined4 __fastcall FUN_004064e0(void *param_1)
...
LAB_00406526:
    ...
    if (uStack_12 != 0) {
      do {
        ...
        FUN_00406950(param_1,(int)piVar4);
      } while (iVar1 < (int)local_18);
    }
    FUN_00406880((int)param_1);
