 ...
 * Entry: 00407940
 * Namespace: Global
 * Prototype: undefined FUN_00407940(int * param_1)
 */


void __fastcall FUN_00407940(int *param_1)

{
  ...
  this = param_1 + 0x25;
  FUN_004050b0(this,0,s_Location_00411438,(BYTE *)&iStack_8);
  FUN_00405070(this,0,s_On_Top_00411430);
  Ordinal_2530();
  FUN_00405070(this,0,&DAT_00411428);
  Ordinal_2293();
