 ...
 * Entry: 004055f0
 * Namespace: Global
 * Prototype: undefined FUN_004055f0(void * this, int param_1)
 */


void __thiscall FUN_004055f0(void *this,int param_1)
  ...
  if (param_1 < 0x101) {
    ...
    *(int *)((int)this + 0x78) = iVar1;
    if (*(int *)((int)this + 0x7c) != iVar1) {
      ...
      FUN_004099a0(*(void **)((int)this + 100),*(void **)((int)this + 0x48),0,local_48,
                   &local_40.left,0);
      ...
      FUN_004099a0(*(void **)((int)this + 100),*(void **)((int)this + 0x48),1,local_48,(int *)0x0,1)
      ;
      ...
      *(undefined4 *)((int)this + 0x7c) = *(undefined4 *)((int)this + 0x78);
      FUN_00408dc0(this,&local_10,0,0);
    }
  }
  return;
}
