 ...
 * Entry: 0040bd70
 * Namespace: Global
 * Prototype: undefined4 * FUN_0040bd70(void * this, undefined4 param_1)
 */


undefined4 * __thiscall FUN_0040bd70(void *this,undefined4 param_1)
  ...
  *unaff_FS_OFFSET = &local_10;
  if (*(int *)((int)this + 0x294) != 0) {
    ...
    if (iVar4 == 0) {
      ...
      local_1c = DAT_004116e0;
      local_18 = DAT_004116e4;
      local_58 = 0;
      local_54 = 0;
      local_50 = 0;
      local_4c = 0;
...
LAB_0040be46:
        ...
        if (bVar2 != pbVar8[1]) goto LAB_0040be46;
        pbVar5 = pbVar5 + 2;
        pbVar8 = pbVar8 + 2;
      } while (bVar2 != 0);
      iVar4 = 0;
...
LAB_0040bea4:
          ...
          bVar2 = pbVar5[1];
          bVar11 = bVar2 < pbVar8[1];
          if (bVar2 != pbVar8[1]) goto LAB_0040bea4;
          pbVar5 = pbVar5 + 2;
          pbVar8 = pbVar8 + 2;
        } while (bVar2 != 0);
        iVar4 = 0;
...
LAB_0040bef4:
            ...
            bVar2 = pbVar5[1];
            bVar11 = bVar2 < pbVar8[1];
            if (bVar2 != pbVar8[1]) goto LAB_0040bef4;
            pbVar5 = pbVar5 + 2;
            pbVar8 = pbVar8 + 2;
          } while (bVar2 != 0);
          iVar4 = 0;
...
LAB_0040bfbd:
              ...
              bVar2 = pbVar5[1];
              bVar11 = bVar2 < pbVar8[1];
              if (bVar2 != pbVar8[1]) goto LAB_0040bfbd;
              pbVar5 = pbVar5 + 2;
              pbVar8 = pbVar8 + 2;
            } while (bVar2 != 0);
            iVar4 = 0;
...
LAB_0040c008:
              ...
              bVar2 = pbVar5[1];
              bVar11 = bVar2 < pbVar8[1];
              if (bVar2 != pbVar8[1]) goto LAB_0040c008;
              pbVar5 = pbVar5 + 2;
              pbVar8 = pbVar8 + 2;
            } while (bVar2 != 0);
            iVar4 = 0;
              ...
              if (iVar4 == 0) {
                ...
                if (iVar4 == 0) {
                  ...
                  if (local_38 == (undefined4 *)0x0) {
                    ...
                    local_74 = FUN_0040b990(local_38);
                  }
                  local_74[1] = param_1;
                ...
                if (iVar4 < -0x7ff8fff1) {
                  if (iVar4 == -0x7ff8fff2) {
                    pcVar9 = s_Not_enough_memory_00411648;
                    goto LAB_0040c1d6;
                  }
                  if (iVar4 == -0x7ffbfef0) {
                    pcVar9 = s_NO_aggregation__0041165c;
                    goto LAB_0040c1d6;
                  }
                }
                else {
                  if (iVar4 == -0x7ff8ffa9) {
                    pcVar9 = s_Invalid_parameter_0041166c;
                  }
                  else if (iVar4 == -0x7787fff6) {
                    pcVar9 = s_Resources_already_in_use__0041169c;
                  }
                  else {
                    if (iVar4 != -0x7787ff9c) goto LAB_0040c1f9;
                    pcVar9 = s_Wave_format_not_supported_00411680;
                  }
LAB_0040c1d6:
                  uVar6 = 0xffffffff;
                  do {
