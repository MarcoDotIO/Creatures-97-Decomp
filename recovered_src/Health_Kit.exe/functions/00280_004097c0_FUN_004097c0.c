 ...
 * Function: FUN_004097c0
 * Entry: 004097c0
 * Namespace: Global
 * Prototype: undefined FUN_004097c0(void * this, int param_1, int param_2)
 */


void __thiscall FUN_004097c0(void *this,int param_1,int param_2)
  ...
  if ((*(byte *)(param_1 + 0x14) & 1) == 0) {
    ...
    *(int *)(param_1 + 0x24) = *(int *)(param_1 + 0x24) + 4;
    ...
    if (0 < *(int *)((int)this + 0xc)) {
      do {
        iVar5 = iVar3 + 1;
        FUN_0040d030(*(void **)(*(int *)((int)this + 8) + iVar3 * 4),param_1,0);
        iVar3 = iVar5;
    ...
    if (0 < *(int *)((int)this + 0xc)) {
      ...
      do {
        ...
        if (puVar4 != (undefined4 *)0x0) {
          this_00 = FUN_0040cf20(puVar4);
        }
        local_8 = 0xffffffff;
        if (this_00 == (undefined4 *)0x0) break;
        FUN_0040d030(this_00,param_1,local_20);
