 ...
 * Entry: 0040a0e0
 * Namespace: Global
 * Prototype: undefined FUN_0040a0e0(void * this, int param_1)
 */


void __thiscall FUN_0040a0e0(void *this,int param_1)

{
  ...
  local_8 = 0xffffffff;
  puStack_c = &LAB_0040a1a2;
  *unaff_FS_OFFSET = &local_10;
  if ((*(byte *)(param_1 + 0x14) & 1) == 0) {
    FUN_0040d030(*(void **)((int)this + 0xc),param_1,0);
    ...
    if (puVar1 != (undefined4 *)0x0) {
      this_00 = FUN_0040cf20(puVar1);
    }
    local_8 = 0xffffffff;
    *(undefined4 **)((int)this + 0xc) = this_00;
    if (this_00 != (undefined4 *)0x0) {
      FUN_0040d030(this_00,param_1,0);
