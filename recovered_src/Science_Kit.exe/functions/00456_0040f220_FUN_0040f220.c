 ...
 * Function: FUN_0040f220
 * Entry: 0040f220
 * Namespace: Global
 * Prototype: undefined4 FUN_0040f220(void * this, undefined4 param_1)
 */


undefined4 __thiscall FUN_0040f220(void *this,undefined4 param_1)

{
  ...
  *unaff_FS_OFFSET = &local_10;
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      pcVar4 = s_Failed_to_open_file__00415224;
      goto LAB_0040f2b8;
    }
  }
  else {
      ...
      if (iVar1 == 0x428) {
        if (*(short *)(*(int *)((int)this + 4) + 0xe) == 8) {
          ...
          *(int *)((int)this + 8) = iVar3;
          ...
          pcVar4 = s_Failed_to_read_file_004151d8;
        }
        else {
          pcVar4 = s_256_colour_bit_map_required__004151ec;
        }
      }
      else {
        pcVar4 = s_Failed_to_read_file__0041520c;
      }
    }
    else {
      pcVar4 = s_Failed_to_read_file__0041520c;
