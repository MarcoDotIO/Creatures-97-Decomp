 ...
 * Function: FUN_004038a0
 * Entry: 004038a0
 * Namespace: Global
 * Prototype: undefined FUN_004038a0(void * this, void * param_1, int param_2, int * param_3, int * param_4)
 */


void __thiscall FUN_004038a0(void *this,void *param_1,int param_2,int *param_3,int *param_4)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    pcVar3 = (char *)FUN_00403870(this,iVar2,local_c + iVar7 + -1);
    pcVar4 = (char *)FUN_0040f510(param_1,local_8,local_4 + local_c + -1);
