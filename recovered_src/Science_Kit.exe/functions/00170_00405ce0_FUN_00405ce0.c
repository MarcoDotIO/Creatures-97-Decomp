 ...
 * Entry: 00405ce0
 * Namespace: Global
 * Prototype: undefined4 * FUN_00405ce0(void * this, int param_1)
 */


undefined4 * __thiscall FUN_00405ce0(void *this,int param_1)

{
  ...
  iVar3 = FUN_00405c40();
  iVar3 = FUN_00405b40(this,iVar3);
  if (iVar3 == 0) {
    puVar2 = FUN_00405230(this,param_1);
