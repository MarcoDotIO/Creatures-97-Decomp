 ...
 * Entry: 00405230
 * Namespace: Global
 * Prototype: undefined4 * FUN_00405230(void * this, undefined4 param_1)
 */


undefined4 * __thiscall FUN_00405230(void *this,undefined4 param_1)
  ...
  *unaff_FS_OFFSET = &local_10;
  if (*(int *)((int)this + 0x294) != 0) {
    ...
    if (iVar4 == 0) {
      ...
      local_1c = DAT_004153e0;
      local_18 = DAT_004153e4;
      local_58 = 0;
      local_54 = 0;
      local_50 = 0;
      local_4c = 0;
...
LAB_00405306:
        ...
        if (bVar2 != pbVar8[1]) goto LAB_00405306;
        pbVar5 = pbVar5 + 2;
        pbVar8 = pbVar8 + 2;
      } while (bVar2 != 0);
      iVar4 = 0;
...
LAB_00405364:
          ...
          bVar2 = pbVar5[1];
          bVar11 = bVar2 < pbVar8[1];
          if (bVar2 != pbVar8[1]) goto LAB_00405364;
          pbVar5 = pbVar5 + 2;
          pbVar8 = pbVar8 + 2;
        } while (bVar2 != 0);
        iVar4 = 0;
...
LAB_004053b4:
            ...
            bVar2 = pbVar5[1];
            bVar11 = bVar2 < pbVar8[1];
            if (bVar2 != pbVar8[1]) goto LAB_004053b4;
            pbVar5 = pbVar5 + 2;
            pbVar8 = pbVar8 + 2;
          } while (bVar2 != 0);
          iVar4 = 0;
...
LAB_0040547d:
              ...
              bVar2 = pbVar5[1];
              bVar11 = bVar2 < pbVar8[1];
              if (bVar2 != pbVar8[1]) goto LAB_0040547d;
              pbVar5 = pbVar5 + 2;
              pbVar8 = pbVar8 + 2;
            } while (bVar2 != 0);
            iVar4 = 0;
...
LAB_004054c8:
              ...
              bVar2 = pbVar5[1];
              bVar11 = bVar2 < pbVar8[1];
              if (bVar2 != pbVar8[1]) goto LAB_004054c8;
              pbVar5 = pbVar5 + 2;
              pbVar8 = pbVar8 + 2;
            } while (bVar2 != 0);
            iVar4 = 0;
              ...
              if (iVar4 == 0) {
                ...
                if (iVar4 == 0) {
                  ...
                  if (local_38 == (undefined4 *)0x0) {
                    ...
                    local_74 = FUN_00404e50(local_38);
                  }
                  local_74[1] = param_1;
                ...
                if (iVar4 < -0x7ff8fff1) {
                  if (iVar4 == -0x7ff8fff2) {
                    pcVar9 = s_Not_enough_memory_00415348;
                    goto LAB_00405696;
                  }
                  if (iVar4 == -0x7ffbfef0) {
                    pcVar9 = s_NO_aggregation__0041535c;
                    goto LAB_00405696;
                  }
                }
                else {
                  if (iVar4 == -0x7ff8ffa9) {
                    pcVar9 = s_Invalid_parameter_0041536c;
                  }
                  else if (iVar4 == -0x7787fff6) {
                    pcVar9 = s_Resources_already_in_use__0041539c;
                  }
                  else {
                    if (iVar4 != -0x7787ff9c) goto LAB_004056b9;
                    pcVar9 = s_Wave_format_not_supported_00415380;
                  }
LAB_00405696:
                  uVar6 = 0xffffffff;
                  do {
