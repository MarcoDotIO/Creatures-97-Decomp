 ...
 * Entry: 00405330
 * Namespace: Global
 * Prototype: undefined4 * FUN_00405330(void * this, int param_1)
 */


undefined4 * __thiscall FUN_00405330(void *this,int param_1)

{
  ...
  iVar3 = FUN_00405290();
  iVar3 = FUN_00405190(this,iVar3);
  if (iVar3 == 0) {
    puVar2 = FUN_00404880(this,param_1);
