...

{
  ...
  puStack_c = &DAT_004088f8;
  puStack_10 = &DAT_00407b18;
  *unaff_FS_OFFSET = &local_14;
  local_1c = &stack0xffffff68;
  local_8 = 0;
  __set_app_type(2);
  DAT_005d93bc = 0xffffffff;
  DAT_005d93c0 = 0xffffffff;
  puVar2 = (undefined4 *)__p__fmode();
  *puVar2 = DAT_0040a6d0;
  puVar2 = (undefined4 *)__p__commode();
  *puVar2 = DAT_0040a6cc;
  _DAT_005d93b8 = *(undefined4 *)_adjust_fdiv_exref;
  FUN_00407b70();
  if (DAT_0040a6c8 == 0) {
    __setusermatherr(&LAB_00407b60);
  }
  __setdefaultprecision();
  initterm(&DAT_0040a038,&DAT_0040a03c);
  local_2c[0].newmode = DAT_0040a6c4;
  __getmainargs(&local_40,&local_3c,local_38,DAT_0040a6c0,local_2c);
  initterm(&DAT_0040a000,&DAT_0040a034);
