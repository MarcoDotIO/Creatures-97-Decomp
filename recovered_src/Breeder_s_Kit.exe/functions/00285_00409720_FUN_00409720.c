 ...
 * Entry: 00409720
 * Namespace: Global
 * Prototype: bool FUN_00409720(void * this, int param_1, int param_2, undefined4 * param_3)
 */


bool __thiscall FUN_00409720(void *this,int param_1,int param_2,undefined4 *param_3)
