 ...
 * Function: FUN_0040bdf0
 * Entry: 0040bdf0
 * Namespace: Global
 * Prototype: undefined FUN_0040bdf0(void * this, int param_1, int param_2)
 */


void __thiscall FUN_0040bdf0(void *this,int param_1,int param_2)
  ...
  if ((*(byte *)(param_1 + 0x14) & 1) == 0) {
    ...
    *(int *)(param_1 + 0x24) = *(int *)(param_1 + 0x24) + 4;
    ...
    if (0 < *(int *)((int)this + 0xc)) {
      do {
        iVar5 = iVar3 + 1;
        FUN_004011c0(*(void **)(*(int *)((int)this + 8) + iVar3 * 4),param_1,0);
        iVar3 = iVar5;
    ...
    if (0 < *(int *)((int)this + 0xc)) {
      ...
      do {
        ...
        if (puVar4 != (undefined4 *)0x0) {
          this_00 = FUN_004010b0(puVar4);
        }
        local_8 = 0xffffffff;
        if (this_00 == (undefined4 *)0x0) break;
        FUN_004011c0(this_00,param_1,local_20);
