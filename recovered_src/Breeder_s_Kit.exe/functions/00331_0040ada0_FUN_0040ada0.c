 ...
 * Entry: 0040ada0
 * Namespace: Global
 * Prototype: undefined4 FUN_0040ada0(void * this, int param_1, int param_2)
 */


undefined4 __thiscall FUN_0040ada0(void *this,int param_1,int param_2)
