 ...
 * Entry: 00408660
 * Namespace: Global
 * Prototype: undefined FUN_00408660(int param_1)
 */


void __fastcall FUN_00408660(int param_1)

{
  ...
  FUN_00409900(*(void **)(param_1 + 0x1b4),0xf3,(int *)(param_1 + 0x11c));
  ...
  iVar3 = _mbscmp(*(uchar **)(param_1 + 0xb0),(uchar *)s_Shop_bmp_004121ac);
  if (iVar3 == 0) {
    FUN_004016f0((void *)(param_1 + 0x2fc),*(void **)(param_1 + 0x1b4),0,local_38,&local_30.left);
    FUN_0040ba60((void *)(param_1 + 0x16c),(RECT *)0x0,0,0);
  }
  if (*(void **)(param_1 + 0xa4) != (void *)0x0) {
    FUN_00404600(*(void **)(param_1 + 0xa4),*(void **)(param_1 + 0x1b4),&local_50,1);
  }
  if (iVar1 <= iVar5) {
    iVar5 = iVar1;
  }
  ...
  FUN_0040ba60((void *)(param_1 + 0x16c),&local_10,0,0);
