 ...
 * Function: FUN_0040b870
 * Entry: 0040b870
 * Namespace: Global
 * Prototype: undefined4 FUN_0040b870(int param_1)
 */


undefined4 __fastcall FUN_0040b870(int param_1)
    ...
    if (puVar2 != (undefined4 *)0x0) {
      ...
      *(undefined4 **)(param_1 + 0x4c) = puVar4;
      if (puVar4 != (undefined4 *)0x0) {
        Ordinal_285(param_1);
        local_8 = 1;
        iVar6 = FUN_0040b000(*(void **)(param_1 + 0x4c),*(int *)(param_1 + 0x48));
        if (iVar6 != 0) {
