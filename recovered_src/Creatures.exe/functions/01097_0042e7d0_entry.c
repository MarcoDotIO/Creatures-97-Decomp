...

{
  ...
  puStack_c = &DAT_00431660;
  puStack_10 = &DAT_0042e978;
  *unaff_FS_OFFSET = &local_14;
  local_1c = &stack0xffffff68;
  local_8 = 0;
  __set_app_type(2);
  DAT_0043a390 = 0xffffffff;
  DAT_0043a394 = 0xffffffff;
  puVar2 = (undefined4 *)__p__fmode();
  *puVar2 = DAT_00437210;
  puVar2 = (undefined4 *)__p__commode();
  *puVar2 = DAT_0043720c;
  _DAT_0043a38c = *(undefined4 *)_adjust_fdiv_exref;
  FUN_0042e9d0();
  if (DAT_00437208 == 0) {
    __setusermatherr(&LAB_0042e9c0);
  }
  __setdefaultprecision();
  initterm(&DAT_0043519c,&DAT_004351a0);
  local_2c[0].newmode = DAT_00437204;
  __getmainargs(&local_40,&local_3c,local_38,DAT_00437200,local_2c);
  initterm(&DAT_00435000,&DAT_00435198);
