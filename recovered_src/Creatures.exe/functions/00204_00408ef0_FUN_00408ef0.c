 ...
 * Entry: 00408ef0
 * Namespace: Global
 * Prototype: int FUN_00408ef0(void * this, int param_1)
 */


/* WARNING: Removing unreachable block (ram,0x00408f78) */

int __thiscall FUN_00408ef0(void *this,int param_1)

{
  ...
  if ((*(int *)((int)this + 0x294) != 0) && (*(int *)((int)this + 0xc) != 0x20)) {
    if (*(int *)((int)this + 0xc) < 0x21) {
      iVar4 = *(int *)((int)this + 0x14);
      pvVar3 = this;
      for (iVar5 = 0; (iVar4 != 0 && (iVar5 < 0x20)); iVar5 = iVar5 + 1) {
        iVar4 = *(int *)((int)pvVar3 + 0x28);
