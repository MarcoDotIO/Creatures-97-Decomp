 ...
 * Function: FUN_0040370b
 * Entry: 0040370b
 * Namespace: Global
 * Prototype: undefined FUN_0040370b(void * param_1)
 */


void __fastcall FUN_0040370b(void *param_1)

{
  ...
  if (BVar3 != 0) {
    ...
    FUN_00403b70(param_1,iVar4,iVar1 + ((int)(iVar2 + (iVar2 >> 0x1f & 7U)) >> 3));
  }
  return;
}
