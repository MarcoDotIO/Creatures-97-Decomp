 ...
 * Entry: 00405050
 * Namespace: Global
 * Prototype: undefined4 FUN_00405050(void * this, undefined4 param_1)
 */


undefined4 __thiscall FUN_00405050(void *this,undefined4 param_1)

{
  ...
  *unaff_FS_OFFSET = &local_10;
  ...
  if (iVar1 == 0) {
    ...
    if (iVar1 == 0) {
      pcVar4 = s_Failed_to_open_file__004100cc;
      goto LAB_004050e8;
    }
  }
  else {
      ...
      if (iVar1 == 0x428) {
        if (*(short *)(*(int *)((int)this + 4) + 0xe) == 8) {
          ...
          *(int *)((int)this + 8) = iVar3;
          ...
          pcVar4 = s_Failed_to_read_file_00410080;
        }
        else {
          pcVar4 = s_256_colour_bit_map_required__00410094;
        }
      }
      else {
        pcVar4 = s_Failed_to_read_file__004100b4;
      }
    }
    else {
      pcVar4 = s_Failed_to_read_file__004100b4;
