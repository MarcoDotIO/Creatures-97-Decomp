 ...
 * Entry: 0040a9f0
 * Namespace: Global
 * Prototype: undefined FUN_0040a9f0(void * this, RECT * param_1, int param_2, int param_3)
 */


void __thiscall FUN_0040a9f0(void *this,RECT *param_1,int param_2,int param_3)

{
  ...
  *unaff_FS_OFFSET = &local_10;
  if (*(int *)((int)this + 0x48) != 0) {
    ...
    FUN_00405380(*(void **)((int)this + 0x48),&local_68.left);
