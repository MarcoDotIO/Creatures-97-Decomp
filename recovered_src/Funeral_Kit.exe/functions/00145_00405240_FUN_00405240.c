 ...
 * Entry: 00405240
 * Namespace: Global
 * Prototype: bool FUN_00405240(void * this, int param_1, int param_2, undefined4 * param_3)
 */


bool __thiscall FUN_00405240(void *this,int param_1,int param_2,undefined4 *param_3)
