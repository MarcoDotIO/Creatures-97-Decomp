 ...
 * Function: FUN_004014f0
 * Entry: 004014f0
 * Namespace: Global
 * Prototype: undefined FUN_004014f0(void * this, void * param_1, int param_2, int * param_3, int * param_4)
 */


void __thiscall FUN_004014f0(void *this,void *param_1,int param_2,int *param_3,int *param_4)

{
  ...
  if (param_1 != (void *)0x0) {
    ...
    pcVar3 = (char *)FUN_004014c0(this,iVar2,local_c + iVar7 + -1);
    pcVar4 = (char *)FUN_00405340(param_1,local_8,local_4 + local_c + -1);
