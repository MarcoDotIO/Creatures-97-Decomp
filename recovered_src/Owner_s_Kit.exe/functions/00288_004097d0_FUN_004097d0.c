 ...
 * Entry: 004097d0
 * Namespace: Global
 * Prototype: undefined FUN_004097d0(int * param_1)
 */


void __fastcall FUN_004097d0(int *param_1)

{
  ...
  this = param_1 + 0x25;
  FUN_004091c0(this,0,s_Location_00412580,(BYTE *)&iStack_8);
  FUN_00409180(this,0,s_On_Top_00412578);
  Ordinal_2530();
  FUN_00409180(this,0,&DAT_00412570);
  Ordinal_2293();
