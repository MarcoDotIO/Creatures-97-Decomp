...

{
  ...
  puStack_c = &DAT_0040f558;
  puStack_10 = &DAT_0040d078;
  *unaff_FS_OFFSET = &local_14;
  local_1c = &stack0xffffff68;
  local_8 = 0;
  __set_app_type(2);
  DAT_0041293c = 0xffffffff;
  DAT_00412940 = 0xffffffff;
  puVar2 = (undefined4 *)__p__fmode();
  *puVar2 = DAT_004127b8;
  puVar2 = (undefined4 *)__p__commode();
  *puVar2 = DAT_004127b4;
  _DAT_00412938 = *(undefined4 *)_adjust_fdiv_exref;
  FUN_0040d0c0();
  if (DAT_004127b0 == 0) {
    __setusermatherr(&LAB_0040d0b0);
  }
  __setdefaultprecision();
  initterm(&DAT_00412054,&DAT_00412058);
  local_2c[0].newmode = DAT_004127ac;
  __getmainargs(&local_40,&local_3c,local_38,DAT_004127a8,local_2c);
