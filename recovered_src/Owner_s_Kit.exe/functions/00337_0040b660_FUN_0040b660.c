 ...
 * Entry: 0040b660
 * Namespace: Global
 * Prototype: undefined4 * FUN_0040b660(void * this, int param_1)
 */


undefined4 * __thiscall FUN_0040b660(void *this,int param_1)

{
  ...
  iVar3 = FUN_0040b5c0();
  iVar3 = FUN_0040b4c0(this,iVar3);
  if (iVar3 == 0) {
    puVar2 = FUN_0040abb0(this,param_1);
