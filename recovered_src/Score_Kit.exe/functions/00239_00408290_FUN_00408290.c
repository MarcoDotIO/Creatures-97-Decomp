 ...
 * Function: FUN_00408290
 * Entry: 00408290
 * Namespace: Global
 * Prototype: undefined4 * FUN_00408290(void * this, undefined4 param_1)
 */


undefined4 * __thiscall FUN_00408290(void *this,undefined4 param_1)
  ...
  *unaff_FS_OFFSET = &local_10;
  if (*(int *)((int)this + 0x294) != 0) {
    ...
    if (iVar4 == 0) {
      ...
      local_1c = DAT_0040c598;
      local_18 = DAT_0040c59c;
      local_58 = 0;
      local_54 = 0;
      local_50 = 0;
      local_4c = 0;
...
LAB_00408366:
        ...
        if (bVar2 != pbVar8[1]) goto LAB_00408366;
        pbVar5 = pbVar5 + 2;
        pbVar8 = pbVar8 + 2;
      } while (bVar2 != 0);
      iVar4 = 0;
...
LAB_004083c4:
          ...
          bVar2 = pbVar5[1];
          bVar11 = bVar2 < pbVar8[1];
          if (bVar2 != pbVar8[1]) goto LAB_004083c4;
          pbVar5 = pbVar5 + 2;
          pbVar8 = pbVar8 + 2;
        } while (bVar2 != 0);
        iVar4 = 0;
...
LAB_00408414:
            ...
            bVar2 = pbVar5[1];
            bVar11 = bVar2 < pbVar8[1];
            if (bVar2 != pbVar8[1]) goto LAB_00408414;
            pbVar5 = pbVar5 + 2;
            pbVar8 = pbVar8 + 2;
          } while (bVar2 != 0);
          iVar4 = 0;
...
LAB_004084dd:
              ...
              bVar2 = pbVar5[1];
              bVar11 = bVar2 < pbVar8[1];
              if (bVar2 != pbVar8[1]) goto LAB_004084dd;
              pbVar5 = pbVar5 + 2;
              pbVar8 = pbVar8 + 2;
            } while (bVar2 != 0);
            iVar4 = 0;
...
LAB_00408528:
              ...
              bVar2 = pbVar5[1];
              bVar11 = bVar2 < pbVar8[1];
              if (bVar2 != pbVar8[1]) goto LAB_00408528;
              pbVar5 = pbVar5 + 2;
              pbVar8 = pbVar8 + 2;
            } while (bVar2 != 0);
            iVar4 = 0;
              ...
              if (iVar4 == 0) {
                ...
                if (iVar4 == 0) {
                  ...
                  if (local_38 == (undefined4 *)0x0) {
                    ...
                    local_74 = FUN_00407eb0(local_38);
                  }
                  local_74[1] = param_1;
                ...
                if (iVar4 < -0x7ff8fff1) {
                  if (iVar4 == -0x7ff8fff2) {
                    pcVar9 = s_Not_enough_memory_0040c500;
                    goto LAB_004086f6;
                  }
                  if (iVar4 == -0x7ffbfef0) {
                    pcVar9 = s_NO_aggregation__0040c514;
                    goto LAB_004086f6;
                  }
                }
                else {
                  if (iVar4 == -0x7ff8ffa9) {
                    pcVar9 = s_Invalid_parameter_0040c524;
                  }
                  else if (iVar4 == -0x7787fff6) {
                    pcVar9 = s_Resources_already_in_use__0040c554;
                  }
                  else {
                    if (iVar4 != -0x7787ff9c) goto LAB_00408719;
                    pcVar9 = s_Wave_format_not_supported_0040c538;
                  }
LAB_004086f6:
                  uVar6 = 0xffffffff;
                  do {
