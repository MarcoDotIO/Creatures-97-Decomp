 ...
 * Entry: 00409030
 * Namespace: Global
 * Prototype: undefined4 FUN_00409030(void * this, int param_1, int param_2)
 */


undefined4 __thiscall FUN_00409030(void *this,int param_1,int param_2)
