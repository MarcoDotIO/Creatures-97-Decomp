 ...
 * Function: FUN_00408ae0
 * Entry: 00408ae0
 * Namespace: Global
 * Prototype: undefined4 FUN_00408ae0(void * param_1)
 */


undefined4 __fastcall FUN_00408ae0(void *param_1)
    ...
    if (0 < *(int *)((int)param_1 + 0x2b0)) {
      if (0 < *(int *)((int)param_1 + 0x2c4)) {
        ...
        do {
          iVar1 = iVar1 + 4;
          iVar2 = iVar2 + 1;
          FUN_00408a30(param_1,*(int **)(*(int *)((int)param_1 + 0x2c0) + -4 + iVar1));
